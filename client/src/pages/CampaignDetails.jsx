    ...
    <div>
      ...
      <div className='mt-[60px] flex lg:flex-row flex-col gap-5'>
        <div className='flex-[2] flex flex-col gap-[40px]'>
          <div>
            <h4 className='font-semibold text-[18px] text-white p-3 bg-[#1c1c24] rounded-t-[10px] w-full text-center uppercase'>
              Creator
            </h4>
        ...
        <div className='flex-[2] flex flex-col gap-[40px]'>
          <div>
            <h4 className='font-semibold text-[18px] text-white bg-[#1c1c24] rounded-t-[10px] w-full text-center uppercase'>
              Story
            </h4>
            <div className='mt-[20px]'>
              <p className='font-[16px] leading-[26px] text-justify text-[12px] text-[#808191]'>
                {state.description}
              </p>
            </div>
          </div>
        ...
        <div className='flex-[2] flex flex-col gap-[40px]'>
          <div>
            ...
            <div className='mt-[20px] flex flex-col gap-4'>
              {donators.length > 0 ? (
                donators.map((item, i) => <div>DONATOR</div>)
              ) : (
                <p className='font-[16px] leading-[26px] text-justify text-[12px] text-[#808191]'>
          ...
          <div className='mt-[20px] flex flex-col p-4 bg-[#1c1c24] rounded-[10px]'>
            ...
            <div className='mt-[30px]'>
              ...
              <div className='my-[20px] p-4 bg-[#13131a] rounded-[10px]'>
                ...
                <p className='mt-[20px] font-normal leading-[22px] text-[#808191]'>Support the project for no reward, just because it speaks to you</p>
              </div>
