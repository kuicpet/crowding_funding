    ...
    <div
      ...
      <div className='flex flex-col p-4'>
        ...
        <div className='block'>
          ...
          <p className='mt-[5px] font-normal  text-[#808191] text-left'>
            {description}
          </p>
        </div>
        <div className='flex justify-between flex-wrap mt-[15px] gap-2'>
          <div className='flex flex-col'>
            ...
            <p className='mt-[3px] font-normal leading-[18px] text-[#808191] sm:max-w-[120px] truncate'>
              Raised of {target}
            </p>
          </div>
        </div>
        ...
        <div className='flex items-center mt-[20px]'>
          ...
          <p className='flex-1 font-normal text-[#808191] truncate'>by <span className='text-[#b2bbd]'>{owner}</span></p>
        </div>
      </div>
    </div>
  )
